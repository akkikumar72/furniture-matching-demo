...
const definitions=[
 ['form-thumbnail.webp','core','Grid cover','Form in Urbanist typography, with a lime frame, rounded white panel and an actual furnished-room render.','Sunbeam-inspired presentation of the actual Form output.'],
